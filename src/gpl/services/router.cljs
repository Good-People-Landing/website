(ns gpl.services.router
  (:require [gpl.lib.defnc :refer [defnc]]
            [gpl.providers.main-provider :refer [use-main-state]]
            [gpl.views.about-view :as about-view]
            [gpl.views.contact-view :as contact-view]
            [gpl.views.landing-view :as landing-view]
            [gpl.views.services-view :as services-view]
            [gpl.views.screening-view :as screening-view]
